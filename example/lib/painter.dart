...
// import 'package:example/from_json.dart';
import 'package:example/camera.dart';
import 'package:example/from_json.dart';
...
class _FlutterPainterExampleState extends State<FlutterPainterExample> {
  ...
  void initBackground() async {
    ...
    final myShape = DrawableFromJson.testFunction();
    // RectangleDrawable myRecatangle = RectangleDrawable(
    //   position: myShape.annotationInfo!.points.first,
    //   size: Size(
    //     (myShape.annotationInfo!.points.first.dx -
    //             myShape.annotationInfo!.points.last.dx)
    //         .abs(),
    //     (myShape.annotationInfo!.points.first.dy -
    //             myShape.annotationInfo!.points.last.dy)
    //         .abs(),
    //   ),
    // );
    // OvalDrawable myOval = OvalDrawable(
    //   size: Size(
    //     (myShape.annotationInfo!.points.first.dx -
    //             myShape.annotationInfo!.points.last.dx)
    //         .abs(),
    ...
    // );
    // FreeStyleDrawable myFreestyle =
    //     FreeStyleDrawable(path: myShape.annotationInfo!.points);
    TextDrawable myText = TextDrawable(
        text: myShape.textAnnotationInfo!.text,
        position: myShape.textAnnotationInfo!.placement,
        style: TextStyle(color: myShape.textAnnotationInfo!.fontColor));

    setState(() {
      backgroundImage = image;
      controller.background =
          ColorBackgroundDrawable(color: Colors.transparent);
      // controller.insertDrawables(
      //   0,
      //   [myRecatangle],
      // );
      // controller.insertDrawables(
      ...
      //   [myOval],
      // );
      controller.insertDrawables(0, [myText]);
    });
  }
  ...
  static IconData getShapeIcon(ShapeFactory? shapeFactory) {
    ...
    if (shapeFactory is ArrowFactory) return Icons.arrow_right_alt_sharp;
